...
// Modified for node canvas by Luke Twyman
...
function Perspective(ctxd, image) {
    ...
    var cvso = new Canvas(parseInt(image.width),parseInt(image.height));
    var ctxo = cvso.getContext('2d');
    ctxo.drawImage(image, 0, 0, cvso.width, cvso.height);

    // prepare a <canvas> for the transformed image
    var cvst = new Canvas(ctxd.canvas.width,ctxd.canvas.height);
...
var proto = Perspective.prototype;
