...
//var GenTweet = require('./js/_GENTWEET');



var T = new Twit(config);
global.tombola = new Tombola();
global.lexicon = new Lexicon();
//genTweet = new GenTweet();
...
function timeInit() {
    ...
    //genTweet.morningLight = morningLight;
    //genTweet.eveningLight = eveningLight;
    //genTweet.nightTime = nightTime;
}

function doTweet() {
    timeInit();

    //var tweet = genTweet.generateTweet();
    generateTweet();
...
//-------------------------------------------------------------------------------------------
//  GENTWEET.js CODE IS PASTED HERE: TEMP
//-------------------------------------------------------------------------------------------
...
function MessageSky() {
    ...
    // sky first //
    if (order) {
        if (tombola.percent(40)) { string += tombola.item(lexicon.LexObservation.sky.pre) + " "; }
